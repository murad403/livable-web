...
const MicroSocialBlueprintModal: React.FC<MicroSocialBlueprintModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
            <div className="bg-white rounded-3xl max-w-2xl w-full p-8 md:p-10 relative shadow-xl border border-gray-100 max-h-[90vh] overflow-y-auto font-sans">
                <button
                    onClick={onClose}
                ...
                <h2 className="text-2xl font-semibold text-title mb-6">Micro-Social Blueprint</h2>

                <div className="py-12 text-center text-gray-400 text-sm font-light">
                    Micro-Social Blueprint details coming soon.
                </div>
