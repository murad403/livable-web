...
const MicroSocialBlueprintModal: React.FC<MicroSocialBlueprintModalProps> = ({ isOpen, onClose, onDone, isInline = true }) => {
    ...
    const content = (
        <div className="bg-white p-6 sm:p-8 border border-gray-200/80 shadow-xs font-sans text-title space-y-6">
            ...
            {/* PHASE 1 */}
            <div>
                <h3 className="text-lg sm:text-xl font-semibold text-title pb-3 border-b border-gray-100 mb-6">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-1">
                            <h4 className={`text-xs sm:text-sm font-semibold text-title ${checkedTasks['task1'] ? 'line-through text-gray-400' : ''}`}>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-1">
                            <h4 className={`text-xs sm:text-sm font-semibold text-title ${checkedTasks['task2'] ? 'line-through text-gray-400' : ''}`}>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-1">
                            <h4 className={`text-xs sm:text-sm font-semibold text-title ${checkedTasks['task3'] ? 'line-through text-gray-400' : ''}`}>
            ...
            <div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-1">
                            <h4 className={`text-xs sm:text-sm font-semibold text-title ${checkedTasks['task4'] ? 'line-through text-gray-400' : ''}`}>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-1">
                            <h4 className={`text-xs sm:text-sm font-semibold text-title ${checkedTasks['task5'] ? 'line-through text-gray-400' : ''}`}>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-1">
                            <h4 className={`text-xs sm:text-sm font-semibold text-title ${checkedTasks['task6'] ? 'line-through text-gray-400' : ''}`}>
