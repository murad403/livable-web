...
const GuidedDiscoveryModal: React.FC<GuidedDiscoveryModalProps> = ({ isOpen, onClose, onDone, isInline = true }) => {
    ...
    const content = (
        <div className="bg-white p-6 sm:p-8 border border-gray-200/80 shadow-xs font-sans text-title space-y-6">
            ...
            {/* Paragraphs */}
            <div className="space-y-4 text-xs sm:text-sm text-title font-light leading-relaxed">
                <p>
                    We have created a mobile companion app to co-guide you during your 72 hours in [City]. This companion app is your engine for structured, independent discovery.
                </p>
                <p>
